        ...
        const <Widget>[
          ...
          Card(
            ...
            child: ListTile(
              ...
              subtitle: Text("1074 Wyandotte St,Windsor,ON",
                style: TextStyle(height: 2.0),
              ),
              leading: Icon(Icons.location_pin),
            ),
          ...
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("343 Wyandotte St,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("999 Drouillard Rd,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("964 wyandotte St ,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("355 Church St ,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("4490 7th Concession Rd,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
            ...
            child: ListTile(
                ...
                subtitle: Text("3285 Manchester Rd,Windsor,ON",
                  style: TextStyle(height: 2.0),
                ),
                leading: Icon(Icons.location_pin)),
          ),
          Card(
              ...
              child: ListTile(
                  ...
                  subtitle: Text("900 Howard Av,Windsor,ON",
                    style: TextStyle(height: 2.0),
                  ),
                  leading: Icon(Icons.location_pin))),
        ]),
